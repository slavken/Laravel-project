                    ...
                    <div class="card-body">
                        <form action="{{ route('categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $category->{'name_' . app()->currentLocale()} }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('color') is-invalid @enderror" id="color" name="color" value="{{ $category->color }}">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            ...
                            <a href="{{ url('admin/categories') }}" class="list-group-item list-group-item-action border-0 rounded active">Categories</a>
