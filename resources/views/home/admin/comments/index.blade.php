    ...
    <div class="container">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            ...
                            @endcan
                            <a href="#" class="list-group-item list-group-item-action border-0 rounded active">{{ __('home.comments') }}</a>
                            @can('cache')
            ...
            <div class="col-md-8 order-md-1">
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            @can('update-comments')
                                                                ...
                                                                <a href="{{ route('comments.edit', $comment->id) }}" class="btn btn-sm btn-light ml-3 border">Edit</a>
                                                            @endcan
                                                            @can('delete-comments')
                ...
                <div class="card mb-4">
                    <h5 class="card-header">{{ __('home.comments') }}</h5>
                                    ...
                                    <tbody>
                                        @foreach ($comments as $comment)
                                            <tr>
                                                ...
                                                <td class="text-nowrap text-center">{{ $comment->created_at->format('H:i - d M Y') }}</td>
                                                @canany(['update-comments', 'delete-comments'])
                                                    <td>
