...
<div>
    <div class="input-group">
        <input v-model="textInput" @keyup.enter="handleButton" type="search" class="form-control" name="search" @input="getItems" placeholder="Search" aria-label="Search">
        <div class="input-group-append">
            <button @click="handleButton" class="btn btn-purple" type="submit"><i class="fas fa-search"></i></button>
        </div>
    </div>
