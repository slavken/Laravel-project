            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-center small" id="navbarText">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('main') }}">{{ __('interface.main') }}</a>
                        </li>
                    ...
                    @guest
                        <a class="btn btn-sm btn-purple mr-2" href="{{ route('login') }}">{{ __('interface.login') }}</a>
                        @if (Route::has('register'))
                            <a class="btn btn-sm btn-success" href="{{ route('register') }}">{{ __('interface.register') }}</a>
                        @endif
                    @else
